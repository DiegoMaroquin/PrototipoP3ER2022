...
public class frmMantenimientolineas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("codigo_linea");
        modelo.addColumn("nombre_linea");
        modelo.addColumn("estado_linea");
        ...
        for (int i = 0; i < cargos.size(); i++) {
            dato[0] = Integer.toString(cargos.get(i).getcodigo_linea());
            dato[1] = cargos.get(i).getnombre_linea();
            dato[2] = cargos.get(i).getestatus_linea();
    ...
    public void buscarCargo() {
        clslineas cargoAConsultar = new clslineas();
        daolineas cargoDAO = new daolineas();
        cargoAConsultar.setcodigo_linea(Integer.parseInt(txtbuscado.getText()));
        cargoAConsultar = cargoDAO.query(cargoAConsultar);
        txtNombre.setText(cargoAConsultar.getnombre_linea());   
        cbox_estado.setSelectedItem(cargoAConsultar.getestatus_linea());
    ...
    private void initComponents() {
        ...
        tablaCargos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "codigo_linea", "nombre_linea", "estado_linea"
            }
        ) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if ( i == 0){
        daolineas cargoDAO = new daolineas();
        clslineas cargoAEliminar = new clslineas();
        cargoAEliminar.setcodigo_linea(Integer.parseInt(txtbuscado.getText()));
...
//        daocargo cargoDAO = new daocargo();
         daolineas cargoDAO = new daolineas();        
         clslineas cargoAInsertar = new clslineas();
        cargoAInsertar.setnombre_linea(txtNombre.getText());
         cargoAInsertar.setestatus_linea(cbox_estado.getSelectedItem().toString());       
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
       ...
       int i =JOptionPane.showConfirmDialog(this, "seguro que quieres modificar este dato ");
        if ( i == 0){
        daolineas cargoDAO = new daolineas();
        clslineas cargoAActualizar = new clslineas();
        cargoAActualizar.setcodigo_linea(Integer.parseInt(txtbuscado.getText()));
        cargoAActualizar.setnombre_linea(txtNombre.getText());
         cargoAActualizar.setestatus_linea(cbox_estado.getSelectedItem().toString());
